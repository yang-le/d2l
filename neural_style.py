...
def compute_loss(X, contents_Y_hat, style_Y_hat, contents_Y, styles_Y_gram):
    ...
    styles_l = [style_loss(Y_hat, Y) * style_weight for Y_hat, Y in zip(style_Y_hat, styles_Y_gram)]
...
if __name__ == "__main__":
    ...
    net = net.to(device)
    contents_X, contents_Y = get_contents(image_shape, device)
    _, styles_Y = get_styles(image_shape, device)
    output = train(contents_X, contents_Y, styles_Y, device, 0.3, 500, 50)
